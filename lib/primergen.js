...
$pg.Chemistry = function() {
  ...
  this.chooseNNObj = function(getNNPair, PrimerNNPairs) {
  ...
  this.calcMeltingTempNN(nnPairArray[i])
...
$pg.csaSeq = new $pg.Sequence($pg.genRandomSeq(64), true, 'CandidateSequence');
$pg.forwardPrimer = new $pg.Sequence($pg.genPrimer($pg.csaSeq.sequence, 0, 21, true), true, 'forwardPrimer');
$pg.reversePrimer = new $pg.Sequence($pg.genPrimer($pg.csaSeq.sequence, 0, 20, false), true, 'reversePrimer');
//$pg.sample_temp = $pg.Chemistry.getMeltingTempNN();
